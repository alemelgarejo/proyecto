              ...
              <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                  ...
                  <div class="mt-3">
                    ...
                    <p class="text-secondary mb-1">Pertenece a por: {{$propiedade->propietario->surname}}, {{$propiedade->propietario->name}}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card mb-3">
              <div class="card-body">
                ...
                <a class="btn btn-secondary btn-sm mt-1" style="color: white;"
                        href="{{ route('propiedades.index') }}">Volver a propiedades</a>
              </div>
            </div>
            </div>
          </div>
