              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        ...
                        href="{{ route('mispropiedades.edit', $mispropiedade->id) }}"><i class="fas fa-edit"></i> Actualizar</a>
                ...
                <a class="btn btn-secondary btn-sm mt-1" style="color: white;"
                        href="{{ route('mispropiedades.index') }}"><i class="fas fa-undo-alt"></i> Mis propiedades</a>
              </div>
            </div>
            </div>
          </div>
