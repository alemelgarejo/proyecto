<x-app-layout>
    ...
    @endif
    <br>
    <a class="btn btn-secondary btn-sm ml-80 mt-3" data-toggle="tooltip" data-placement="top" title="Ver imágenes" href="{{ route('files.index2', $propiedade->id) }}"><i class="fas fa-images"></i></a>&nbsp;&nbsp;
