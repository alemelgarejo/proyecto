    ...
    <body class="font-sans antialiased" id="heading">
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <main x-data="{ 'isDialogOpen': false }" @keydown.escape="isDialogOpen = false">
                <section>
                    <a href="#heading" type="button" style="margin: -2px 0px 15px 45px; color:black;" @click="isDialogOpen = true"><img src="{{asset('images/information1.png')}}" alt="deletelogo"  style="float: left; " >&nbsp;&nbsp;Iconos</a>
                    <!-- overlay -->
                        ...
                        <div class="bg-white shadow-2xl m-4 sm:m-8" x-show="isDialogOpen" @click.away="isDialogOpen = false">
                            ...
                            <div class="p-2">
                                ...
                                <aside class="max-w-lg m-2 p-4 bg-yellow-100 border border-yellow-500">
                                    ...
                                    <p>&nbsp;&nbsp;Ver imágenes <img src="{{asset('images/image.png')}}" style="float: left;" alt="infologo"></p>
                                    <p>&nbsp;&nbsp;Añadir elemento <img src="{{asset('images/add-file.png')}}" style="float: left;" alt="infologo"></p>
                                    <p>&nbsp;&nbsp;Guardar información <img src="{{asset('images/save.png')}}" style="float: left;" alt="infologo"></p>
                                    <p>&nbsp;&nbsp;Añadir imágenes <img src="{{asset('images/add.png')}}" style="float: left;" alt="infologo"></p>
                                </aside>
