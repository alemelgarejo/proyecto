...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('fontawesonme-5.5/css/all.min.css')}}"> --}}
  ...
  <body>
    ...
    <section id="hero" class="text-white tm-font-big tm-parallax">
      ...
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">
        <div class="container">
          <div class="tm-next">
              <a href="#hero" class="navbar-brand"><i class="fas fa-home"></i> Inmodata</a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#introduction"><i class="fas fa-address-card"></i> Introduction</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#work"><i class="fas fa-briefcase"></i> Our Work</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#contact"><i class="fas fa-address-book"></i> Contact Us</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title"><i class="fas fa-home"></i> Inmodata</h2>
            <p class="tm-hero-subtitle">
              Tu web inmobiliaria
              <br />by Alejandro Melgarejo Curbelo
            </p>
        </div>
      </div>
    ...
    <section id="contact" class="tm-section-pad-top tm-parallax-2">
      <div class="container tm-container-contact">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
              <a href="tel:655664782" class="tm-contact-item-link">
                  <i class="fas fa-3x fa-phone mr-4"></i>
                  <span class="mb-0">655-664-782</span>
              </a>
            </div>
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
              <a href="mailto:info@company.co" class="tm-contact-item-link">
                  <i class="fas fa-3x fa-envelope mr-4"></i>
                  <span class="mb-0">melgarejoale.contact@gmail.com</span>
              </a>
            </div>
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
              <a href="https://www.google.com/maps/place/Secondary+School+Zonzamas/@28.967479,-13.5606247,15z/data=!4m2!3m1!1s0x0:0xe1c08d4252e5ad1c?sa=X&ved=2ahUKEwityuG49sjvAhUUSxUIHW9NCx4Q_BIwDnoECB8QBQ" target="__blank" class="tm-contact-item-link">
                  <i class="fas fa-3x fa-map-marker-alt mr-4"></i>
                  <span class="mb-0">Localizaciรณn</span>
              </a>
            </div>
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
              <a href="/dashboard" target="__blank" class="tm-contact-item-link">
                  <i class="fas fa-3x fa-users-cog mr-4"></i>
                  <span class="mb-0">Administración</span>
              </a>
            </div>
        </div>
      </div>
      <footer class="text-center small tm-footer">
          <p class="mb-0">
            Copyright &copy; 2021 Inmodata

            - <a rel="nofollow" href="https://github.com/alemelgarejo" target="__blank" class="tm-footer-link">Alejandro Melgarejo Curbelo</a>
          </p>
        </footer>
    </section>
